...
## cacheSolve returns the inverse of the matrix. It first checks for the inverse, and if it is already calculated then it #retrieves the inverse from cache using getinverse function and skips the computation (second part of the function). If not, #then it computes the inverse and sets the value in the cache by using setinverse function.
